...
from sqlalchemy import Column, Integer, String, Float, column, ForeignKey, Boolean
...
if __name__ == '__main__':
    with app.app_context():
        ...
        db.create_all()
        user1=User(name='my',username='km',password=str(hashlib.md5('123456'.encode('utf-8')).hexdigest())
                   ,avatar='https://img.idesign.vn/2020/03/id12.jpg')
